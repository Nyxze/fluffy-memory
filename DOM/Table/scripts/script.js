...
(function () {
    ...
    */
    ...
    $('tbody tr').each(function () { // Renvoi une nodeList
        let td = $('<td>').appendTo(this);
        let id = $(this).find('td:eq(0)').text();   // Crée un table header
        let a = $('<a>').appendTo(td).attr({
            "href": '#',
            "id": id,
            "title": "Delete contact N°" + id
        ...
        $('<img src="img/delete.png">').appendTo(a);
