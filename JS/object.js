...
person = {
    ...
    getFullName: function () {
        return console.log(`${this.name} ${this.firstName.toUpperCase()}`);
    }
}

person.name = "Bart" // person.name est public donc modifiable 
person.getFullName();

// Isolation grace a une fonction 
...
let name = createPerson("Rene", "Lataupe");
name.getFullName();


// Pause  bidouilles
const app = (function(){  // Définition
        return {
            name: ""
        }
    }
